			...
			<main>
				...
				<div id="login-wrap">
					...
					<?php if(isset($_GET['Login']) && $_GET['Login']=='False') {
						...
						?>
					<div>Username: </div>
					<input type="text" name="Username" placeholder="Email address" size="30" maxlength="64" autofocus="autofocus" required="required" pattern="[^;&quot;'&gt;&lt;\r\t\f\v]+" title="Do not include: ' ; &quot; &gt; &lt;"/> <!-- Database has limit of 64 chars -->
