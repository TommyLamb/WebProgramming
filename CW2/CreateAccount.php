...
$addressStatement = $db->prepare('insert into Address (UID,Line1,Line2,Line3,Line4,City,Postcode,County,Country) Values (:UID,:Line1,:Line2,:Line3,:Line4,:City,:Postcode,:County,:Country)');
